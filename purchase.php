...
<div class="topbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="purchase.php" style="text-decoration:underline;">Add Purchase</a>
...
<div class="container">
  ...
  <form id="purchaseForm" method="POST" action="purchase_submit.php">
    ...
    <table id="purchaseTable">
      ...
      <tbody>
        <tr class="item-row">
          ...
          <td><select name="items[0][addition]" class="addition"><option value="">--</option></select></td>
          <td><select name="items[0][axis]" class="axis"><option value="">--</option></select></td>
